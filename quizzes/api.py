...
from .serializers import LoginSerializer, RegisterSerializer, UserSerializer, QuizListSerializer, QuizDetailSerializer, MyQuizListSerializer, UsersAnswerSerializer, QuizResultSerializer
...
class QuizResultsAPI(generics.GenericAPIView):
  serializer_calls = QuizResultSerializer
  permision_clases =  [
    permissions.IsAuthenticated
  ]
